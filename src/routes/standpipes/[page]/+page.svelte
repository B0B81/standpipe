				...
				<thead>
			  	...
			  	<tbody>
					...
					<tr>
						...
						<td>
							<div class="btn-group">
							<form action="?/edit/deleteStandpipes&id={standpipe.id}" method="POST">
								<div class="pr-1">
							...
							<form action="/standpipes/edit/{standpipe.id}">
								<button class="btn btn-sm btn-square btn-outline" type="submit">
...
<div>
	{#each Array(totalPages) as _, idx}
		<a href="/standpipes/{idx + 1}" class={currentPage === idx ? 'text-emerald-300' : ''}>
			{idx +1}
		</a>
	{/each}
</div>	
